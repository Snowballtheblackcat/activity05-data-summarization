...
**Response**:The first 10 rows of the dataset is shown.
...
**Response**:The median, or middle will be $36,000. It will also be skewed right, with more frequencies in the lower half of income earnings. 
...
**Response**: STEM majors will have a higher median income than other majors. 
...
**Response**: The code outputs a data table which is easy to read. 
...
**Response**: Majors with a higher median also have a large rage of median salaries.
...
**Response**: There are less women that choose stem majors. Unemployment rates are higher in more liberal majors. 
...
**Response**:The data table is easier to read with this code. 
...
**Response**:Medians that have a higher earning also have a larger range of median salaries. 
